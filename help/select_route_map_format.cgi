...
<h2 align=center>Select map output format for selected routes</h2>
Show the selected routes (plotted against current roads and conditions).
<p><b>You cannot select an output format until you have selected some route
to process.</b>  Some output formats only support a limited number of routes.

...
install:
	install -d -m 777 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(LOGDIR)/. 
	...
	install -d -m 777 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(LOGDIR)/patrons 
	...
	: install -d -m 755 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(ROUTING_WWW_DIR)/. 
	...
	install -d -m 755 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(WWWDIR)/forms 
	rm -f $(WWWDIR)/help
	...
	install -d -m 755 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(WWWDIR)/icons 
	install -d -m 755 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(WWWDIR)/icons/kml 
	rm -f $(WWWDIR)/progress
	ln -s	 $(LOGDIR)/progress			$(WWWDIR)/progress
	install -d -m 755 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(WWWDIR)/ref 
	install -d -m 777 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(WWWDIR)/routes 
	install -d -m 755 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(WWWDIR)/routing_common
	...
	install -d -m 755 -o $(SYSTEMUSER) -g $(SYSTEMGROUP)		$(WWWDIR)/routing 

#!/usr/bin/perl -w
#
#indx#	upgrade_log_format.pl - Obsolete - Used to transfer old style log files to new
#@HDR@	$Id$
#@HDR@
...
########################################################################
#doc#	upgrade_log_format.pl - Obsolete - Used to transfer old style log files to new
########################################################################

...
#
#indx#	completed_route_update.pl - Obsolete software called via e-mail with older routing sw
#@HDR@	$Id$
#@HDR@
...
########################################################################
#doc#	completed_route_update.pl - Obsolete software called via e-mail with older routing sw
########################################################################
